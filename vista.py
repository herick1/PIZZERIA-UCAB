...
#solo es utilizada para tener la vista en la pantalla
...
while(1==1):
	...
	print("Pizza numero:",pizzas)
	print("Opciones:")
	tamaño = input("Tamaños: Grande( g ) Mediana ( m ) Personal ( p ) :")
	print("=> Debe seleccionar un tamaño correcto !!")
	print("Tamaño seleccionado:", tamaño) #aqui acordarme poner la refereancia completa al nombre
